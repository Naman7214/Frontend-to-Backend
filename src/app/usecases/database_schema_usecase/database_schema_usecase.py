...
class DatabaseSchemaUseCase:    
    ...
    async def execute(self, json_file_path: str, repo_path: str) -> Dict[str, Any]:
        try:
    ...
    async def _process_json_file(self, json_file_path: str, repo_path: str) -> Dict[str, Any]:
        try:
            ...
            print(f"Updated JSON with schema analysis and mock data status saved to {output_file}")
    ...
    async def _process_endpoint(self, endpoint: Dict[str, Any], repo_path: str) -> Dict[str, Any]:
        ...
        if schema_analysis and not schema_analysis.get("error"):
            ...
            if mock_data_list:
                ...
                insertion_success = await self.helper.insert_to_mongodb_async(repo_path, collection_name, mock_data_list)
            ...
            print(f"Skipping mock data generation for endpoint {endpoint.get('endpointName')} due to schema analysis error or empty result.")
