...
from src.app.usecases.code_contructor_usecase.code_constructor_usecase import (
    CodeConstructorUseCase,
)
from src.app.usecases.code_generation_usecase.code_generation_usecase import (
    CodeGenerationUseCase,
)
from src.app.usecases.database_schema_usecase.database_schema_usecase import (
...
from src.app.usecases.set_priority_usecase.set_priority_usecase import (
    SetPriorityUseCase,
)
...
class BackendCodeGenController:
    ...
    def __init__(
        ...
        postman_collection_usecase: PostmanCollectionUseCase = Depends(
            PostmanCollectionUseCase
        ),
    ...
    async def code_gen(self, url: str):
        ...
        output_path, output_path_with_sample_payload, simplified_end_points = (
            await self.endpoint_usecase.execute(
                repo_path=repo_path,
    ...
    async def stream_code_gen(self, url: str):
        ...
        try:
            ...
            code_json_path = f"Projects/{project_uuid}/final_code.json"
            zip_path = await self.code_constructor_usecase.execute(
                code_json_path
            )
