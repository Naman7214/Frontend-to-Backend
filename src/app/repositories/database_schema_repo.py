...
class DatabaseRepository: 
    ...
    def create_collection(self, db: Database, collection_name: str) -> Collection:
    ...
    def insert_many(self, collection: Collection, data_list: List[Dict[str, Any]]) -> List[str]:
        result = collection.insert_many(data_list)
        return [str(id) for id in result.inserted_ids]
    
    def find_one(self, collection: Collection, query: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        result = collection.find_one(query)
        return result
    
    def find_many(self, collection: Collection, query: Dict[str, Any]) -> List[Dict[str, Any]]:
        cursor = collection.find(query)
        return list(cursor)
    
    def update_one(self, collection: Collection, query: Dict[str, Any], update_data: Dict[str, Any]) -> int:
    ...
    def insert_data_from_json(self, repo_path: str, json_path: str, collection_name: str) -> List[str]:
